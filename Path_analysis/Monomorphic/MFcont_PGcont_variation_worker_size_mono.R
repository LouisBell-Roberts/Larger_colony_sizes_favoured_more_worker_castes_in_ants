...
all_variables <- dplyr::filter(ant_data, caste.number <2, complete.cases(worker.size.variation), complete.cases(queen.mating.frequency), complete.cases(colony.size), complete.cases(queen.number.continuous))
...
### Main analysis ###
##NCuniform_stem
NCuniform_stem_result <- phylo_path(models, data = all_variables, tree = NCuniform_stem_pruned, method = "logistic_MPLE", model = "lambda", lower.bound =0, upper.bound = 1)
...
##NCuniform_crown
NCuniform_crown_result <- phylo_path(models, data = all_variables, tree = NCuniform_crown_pruned, method = "logistic_MPLE", model = "lambda", lower.bound =0, upper.bound = 1)
...
##FBD_stem
FBD_stem_result <- phylo_path(models, data = all_variables, tree = FBD_stem_pruned, method = "logistic_MPLE", model = "lambda", lower.bound =0, upper.bound = 1)
...
##FBD_crown
FBD_crown_result <- phylo_path(models, data = all_variables, tree = FBD_crown_pruned, method = "logistic_MPLE", model = "lambda", lower.bound =0, upper.bound = 1)
