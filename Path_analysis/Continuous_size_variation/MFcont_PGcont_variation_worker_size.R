...
# Create a PDF file
# pdf("/Users/louis.bell-roberts/Documents/Github/Testing_the_size_complexity_hypothesis_in_ants/Figures/Path_analysis/Plots/Multi_panels/Path_analysis_4panel_siz_var_cont.pdf", width = 13, height = 12)
jpeg("/Users/louis.bell-roberts/Documents/Github/Testing_the_size_complexity_hypothesis_in_ants/Figures/Path_analysis/Plots/Multi_panels/Path_analysis_4panel_siz_var_cont.jpg", width = 13, height = 12, units = "in", res = 640, quality = 100)
...
write.csv(combined_summaries, file = "/Users/louis.bell-roberts/Documents/Github/Testing_the_size_complexity_hypothesis_in_ants/Path_analysis/Continuous_size_variation/Result_CSV/Continuous/Path_analysis_summary_siz_var_cont.csv", row.names = FALSE)
...
write.csv(Siz_var_coef_stats, file = "/Users/louis.bell-roberts/Documents/Github/Testing_the_size_complexity_hypothesis_in_ants/Path_analysis/Continuous_size_variation/Result_CSV/Continuous/Path_analysis_siz_var_coef_stats_cont.csv", row.names = F)
