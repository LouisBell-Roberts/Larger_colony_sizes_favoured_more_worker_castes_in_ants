...
all_variables_PGbinary <- dplyr::filter(ant_data, caste.number <2, complete.cases(worker.size.variation), complete.cases(queen.mating.frequency), complete.cases(colony.size), complete.cases(queen.number.continuous))
