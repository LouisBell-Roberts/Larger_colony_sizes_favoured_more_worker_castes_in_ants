...
all_variables$queen.number.categorical <- as.factor(ifelse(all_variables$queen.number.categorical > 0,1,0))
...
ggsave(filename = "/Users/louis.bell-roberts/Documents/Github/Testing_the_size_complexity_hypothesis_in_ants/Figures/Path_analysis/Plots/FBD_stem_discrete_MFcat_PGcat.pdf", width = 6.5, height = 6)
