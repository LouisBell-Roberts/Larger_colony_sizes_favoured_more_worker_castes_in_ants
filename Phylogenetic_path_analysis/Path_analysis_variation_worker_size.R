...
#Filter data
all_variables_PGbinary <- dplyr::filter(ant_data, complete.cases(worker.size.variation), complete.cases(queen.mating.frequency), complete.cases(colony.size), complete.cases(queen.number))
